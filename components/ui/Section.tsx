...
export const Section = forwardRef<HTMLElement, SectionProps>(function Section(
  ...
  const bgClasses = {
    ...
    'gray-100': 'bg-gray-100 dark:bg-gray-950 text-gray-900 dark:text-white transition-colors duration-200',
    'gray-900': 'bg-gray-900 dark:bg-white text-white dark:text-gray-900 transition-colors duration-200',
    'gray-800': 'bg-gray-800 dark:bg-gray-100 text-white dark:text-gray-900 transition-colors duration-200',
    ...
    'projects': 'bg-gray-100 dark:bg-gray-900 text-gray-900 dark:text-white transition-colors duration-200',
  };
